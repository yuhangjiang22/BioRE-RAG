...
class Retriever:
    ...
    def __init__(self, retriever_name="ncbi/MedCPT-Query-Encoder", corpus_name="pubmed", db_dir="biomedrag-rebel/biomedrag/MedRAG/corpus", **kwarg):
...
class RetrievalSystem:
    ...
    def __init__(self, retriever_name="MedCPT", corpus_name="PubMed", db_dir="./corpus"):
        self.retriever_name = retriever_name
        self.corpus_name = corpus_name
